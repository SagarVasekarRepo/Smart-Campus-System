...
<div class="PageBackgroundSimpleGradient">
    ...
    <div class="Main">
                      ...
                      <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>UPDATING <%=update %> OF <%=canteen%> CANTEEN</center></span><br>
                            </h2>
                            ...
                            m=dao.getStaffSibaca1(id);
                            
                            
                             %>
                            
                                 <center>
                                 	<form action="SibacaCanteenStaffUpdate">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                            ...
                            m=dao.getContactSibaca(id);
                            
                            
                             %>
                            
                                 <center>
                                 	<form action="SibacaContactUpdate">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                            ...
                            m=dao.getStaffSit1(id);
                            
                            
                             %>
                            
                                 <center>
                                 	<form action="SitCanteenStaffUpdate">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 				Staff Id :: <input type="text" name="id" value=<%=m.emp_id %> readonly="readonly"></input> <br><br><br><br>
                            ...
                            m=dao.getContactSit(id);
                            
                            
                             %>
                            
                                 <center>
                                 	<form action="SitContactUpdate">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 			 Id :: <input type="text" name="id" value=<%=m.id %> readonly="readonly"></input> <br><br><br><br>
        ...
        <%
                            ...
                            m=dao.getStaffStes1(id);
                            
                            
                             %>
                            
                                 <center>
                                 	<form action="StesCanteenStaffUpdate">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 				Staff Id :: <input type="text" name="id" value=<%=m.emp_id %> readonly="readonly"></input> <br><br><br><br>
                            ...
                            m=dao.getContactStes(id);
                            
                            
                             %>
                            
                                 <center>
                                 	<form action="StesContactUpdate">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 			 Id :: <input type="text" name="id" value=<%=m.id %> readonly="readonly"></input> <br><br><br><br>

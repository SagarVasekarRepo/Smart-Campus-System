        ...
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                <div class="Header">
                    ...
                    <div class="logo">
                        <h1 id="name-text" class="logo-name"><a href="#">ARJUN MESS</a></h1>
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="MessFetchOperation?mess=arjun&want=staff"  class=" active"><span><span>Staff Details</span></span></a>
                                     
                                    </li>
                        <li><a href="MessFetchOperation?mess=arjun&want=contact"><span><span>Contact</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>ARJUN MESS STAFF</center></span><br>
                            </h2>
                            <center> 
                            <a href="messInsertOperation.jsp?mess=ARJUN&insert=STAFF">Insert New Staff Member</a>
                            </center>
                         <br><br>
...
<%
        ...
        <td><a href="MessDeleteOperation?mess=ARJUN&on=staff&id=<%= staff[count].emp_id %>">Delete</a></td>
        <td><a href="messUpdateOperation.jsp?mess=ARJUN&update=STAFF&id=<%= staff[count].emp_id %>">Update</a></td>
        <%count++; %>
    </TR>
    <%} %>   </tbody> </table>

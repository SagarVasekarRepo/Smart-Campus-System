        ...
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                <div class="Header">
                    ...
                    <div class="logo">
                        <h1 id="name-text" class="logo-name"><a href="#">SHIVNERI HOSTEL</a></h1>
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="HostelFetchOperation?hostel=shivneri&want=staff"><span><span>Hostel Staff Details</span></span></a>
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>Shivneri Room Details</center></span><br>
                            </h2>
                            
                            <div class="PostContent">
                            
                            <center>
						 <a href="hostelInsertOperation.jsp?hostel=SHIVNERI&insert=ROOMDETAIL">Insert New Room Detail</a>
...
<%
      ...
      <td><a href="HostelDeleteOperation?hostel=SHIVNERI&on=room&id=<%= rooms[count].id %>">Delete</a><br><br>
        <a href="hostelUpdateOperation.jsp?hostel=SHIVNERI&update=room&id=<%= rooms[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <tr></tr><tr></tr><tr></tr>
    <%} %>   </tbody> </table>

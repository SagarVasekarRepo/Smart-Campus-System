            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="MessFetchOperation?mess=sahdev&want=staff"><span><span>Staff Details</span></span></a>
                                     
                                    </li>
                        <li><a href="MessFetchOperation?mess=sahdev&want=contact" class=" active"><span><span>Contact Details</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>Sahdev Mess Contacts Details</center></span><br>
                            </h2>
                            
                            <div class="PostContent">
                            
                            <center>
						 <a href="messInsertOperation.jsp?mess=SAHDEV&insert=CONTACT">Insert New Contact Person</a>
...
<%
      ...
      <td><a href="MessDeleteOperation?mess=SAHDEV&on=CONTACT&id1=<%= contacts[count].id %>">Delete</a><br><br>
        <a href="messUpdateOperation.jsp?mess=SAHDEV&update=CONTACT&id=<%= contacts[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <tr></tr><tr></tr><tr></tr>
    <%} %>   </tbody> </table>

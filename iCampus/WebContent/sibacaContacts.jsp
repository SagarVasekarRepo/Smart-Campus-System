            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="CanteenFetchOperation?canteen=sibaca&want=contact" class=" active"><span><span>Contact</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>Sibaca Canteen Contacts Details</center></span><br>
                            </h2>
                            
                            <div class="PostContent">
                            
                            <center>
						 <a href="canteenInsertOperation.jsp?canteen=SIBACA&insert=CONTACT">Insert New Contact Person</a>
...
<%
      ...
      <td><a href="CanteenDeleteOperation?canteen=SIBACA&on=CONTACT&id1=<%= contacts[count].id %>">Delete</a><br><br>
        <a href="canteenUpdateOperation.jsp?canteen=SIBACA&update=CONTACT&id=<%= contacts[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <tr></tr><tr></tr><tr></tr>
    <%} %>   </tbody> </table>

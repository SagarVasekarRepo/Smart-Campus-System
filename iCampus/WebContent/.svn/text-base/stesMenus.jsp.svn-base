            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="CanteenFetchOperation?canteen=stes&want=menu"  class=" active"><span><span>Manage Menu's</span></span></a></li>
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>STES Canteen Menu's</center></span><br>
                            </h2>
                            <div class="PostContent">
						 <center>
						 <a href="canteenInsertOperation.jsp?canteen=STES&insert=MENU">Insert New Menu</a><br/><br/>
...
<%
        ...
        <td><a href="CanteenDeleteOperation?canteen=STES&on=menu&id=<%= menus[count].id %>">Delete</a></td>
        <td><a href="canteenUpdateOperation.jsp?canteen=STES&update=MENU&id=<%= menus[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <%} %>   </tbody> </table>

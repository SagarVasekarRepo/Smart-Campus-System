            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="MessFetchOperation?mess=KALYANI&want=menu" class=" active"><span><span>Manage Menu's</span></span></a></li>
                        <li><a href="MessFetchOperation?mess=KALYANI?want=staff"><span><span>Staff Details</span></span></a>
                                     
                                    </li>
                        <li><a href="MessFetchOperation?mess=KALYANI&want=contact"><span><span>Contact Details</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">

            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="SecurityFetchOperation?want=staff"  class=" active"><span><span>Security Staff Details</span></span></a>
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>SECURITY STAFF</center></span><br>
                            </h2>
                            <center> 
                            <a href="securityInsertOperation.jsp?insert=STAFF">Insert New Staff Member</a>
                            </center>
                         <br><br>
					 ...
					 <tbody>
<%
					SecurityStaff staff[]=(SecurityStaff[])request.getAttribute("result");
    				...
    				<TR id=count >
        <TD><%=staff[count].id %></TD>
        <TD><%=staff[count].name %></TD>
        <TD><%=staff[count].role %></TD>
        
        <td><a href="SecurityDeleteOperation?on=staff&id=<%= staff[count].id %>">Delete</a></td>
        <td><a href="securityUpdateOperation.jsp?update=STAFF&id=<%= staff[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <%} %>   </tbody> </table>

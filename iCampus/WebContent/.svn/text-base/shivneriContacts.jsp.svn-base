        ...
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                <div class="Header">
                    ...
                    <div class="logo">
                        <h1 id="name-text" class="logo-name"><a href="#">SHINERI HOSTEL</a></h1>
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="HostelFetchOperation?hostel=shivneri&want=staff"><span><span>Staff Details</span></span></a>
                                     
                                    </li>
                        <li><a href="HostelFetchOperation?hostel=shivneri&want=contact" class=" active"><span><span>Contact Details</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>Shivneri Hostel Contacts Details</center></span><br>
                            </h2>
                            
                            <div class="PostContent">
                            
                            <center>
						 <a href="hostelInsertOperation.jsp?hostel=SHIVNERI&insert=CONTACT">Insert New Contact Person</a>
...
<%
      ...
      <td><a href="HostelDeleteOperation?hostel=SHIVNERI&on=CONTACT&id1=<%= contacts[count].id %>">Delete</a><br><br>
        <a href="hostelUpdateOperation.jsp?hostel=SHIVNERI&update=CONTACT&id=<%= contacts[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <tr></tr><tr></tr><tr></tr>
    <%} %>   </tbody> </table>

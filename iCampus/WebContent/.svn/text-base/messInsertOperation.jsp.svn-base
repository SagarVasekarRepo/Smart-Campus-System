...
<%@page import="dao.DaoMess" %><html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
<head>
    <!--
                      ...
                      <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                ...
                                <center>
                                ADDING NEW <%=insert %> TO <%=mess %> MESS
                                </center>
                                </span>
                            </h2>
                            <br/>
                            <div class="PostContent">
                                 ...
                                 {
                                  %>
                                   <form action="ArjunMessStaffInsert">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 ...
                                 {
                                 %>
                                   <form action="ArjunMessContactInsert">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 				Enter the Name of Member   :: <input type="text" name="name" /><br><br><br><br>
                                 ...
                                 <form action="KalyaniMessStaffInsert">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 				Enter the Name of Member   :: <input type="text" name="name" /><br><br><br><br>
                                 ...
                                 { %>
                                        ...
                                        <form action="KalyaniMessContactInsert">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 				Enter the Name of Member   :: <input type="text" name="name" /><br><br><br><br>
                                 ...
                                 else if(insert.equalsIgnoreCase("staff"))
                                 {
                                  ...
                                  <form action="SahdevMessStaffInsert">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 				Enter the Name of Member   :: <input type="text" name="name" /><br><br><br><br>
                                 ...
                                 { %>
                                       <form action="SahdevMessContactInsert">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 				Enter the Name of Member   :: <input type="text" name="name" /><br><br><br><br>

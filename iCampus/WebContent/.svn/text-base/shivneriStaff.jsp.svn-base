        ...
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                <div class="Header">
                    ...
                    <div class="logo">
                        <h1 id="name-text" class="logo-name"><a href="#">SHIVNERI HOSTEL STAFF</a></h1>
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="HostelFetchOperation?hostel=shivneri&want=staff"  class=" active"><span><span>Staff Details</span></span></a>
                                     
                                    </li>
                        <li><a href="HostelFetchOperation?hostel=shivneri&want=contact"><span><span>Contact Details</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                ...
                <div class="contentLayout">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            ...
                            <center> 
                            <a href="hostelInsertOperation.jsp?hostel=SHIVNERI&insert=STAFF">Insert New Staff Member</a>
                            </center>
                         <br><br>
...
<%
        ...
        <td><a href="HostelDeleteOperation?hostel=SHIVNERI&on=staff&id=<%= staff[count].emp_id %>">Delete</a></td>
        <td><a href="hostelUpdateOperation.jsp?hostel=SHIVNERI&update=STAFF&id=<%= staff[count].emp_id %>">Update</a></td>
        <%count++; %>
    </TR>
    <%} %>   </tbody> </table>

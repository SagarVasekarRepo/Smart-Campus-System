            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="CanteenFetchOperation?canteen=sit&want=menu"  class=" active"><span><span>Manage Menu's</span></span></a></li>
                        <li><a href="CanteenFetchOperation?canteen=sit&want=staff"><span><span>Staff Details</span></span></a>
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>SIT Canteen Menu's</center></span><br>
                            </h2>
                            <div class="PostContent">
					<center>
                            <center>
				<a href="canteenInsertOperation.jsp?canteen=SIT&insert=MENU">Insert New Menu</a><br><br>					 
							
                         </center>	 
					 <TABLE cellpadding="15" border="1" style="background-color: #ffffcc;" align="center" id="my_table">
					 <tbody>
<%
					Menu menus[]=(Menu[])request.getAttribute("result");
    				...
    				<TR id=count >
    				<TD><%=menus[count1].id %></TD>
        <TD><%=menus[count1].name %></TD>
        <TD><%=menus[count1].price %></TD>
        
        
      <td><a href="CanteenDeleteOperation?canteen=SIT&on=menu&id=<%= menus[count1].id %>">Delete</a></td>
        <td><a href="canteenUpdateOperation.jsp?canteen=SIT&update=MENU&id=<%= menus[count1].id %>">Update</a></td>
        <%count1++; %>
    </TR>
    <%} %>   </tbody> </table>

        ...
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                <div class="Header">
                    ...
                    <div class="logo">
                        <h1 id="name-text" class="logo-name"><a href="#">Smart Campus System</a></h1>
                        <div id="slogan-text" class="logo-text">No one covers the campus as we do</div>
                    </div>
                </div>
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="#"><span><span>History</span></span></a></li>
                            ...
                            <div class="Block-body">
                                ...
                                <div class="BlockContent">
                                    <div class="BlockContent-body">
                                        ...
                                        <b>STES Campus</b><br />
                                        Lonavala,Kusgaon<br />
                                        Email: <a href="mailto:info@company.com">info@stes.com</a><br />
                                        <br/>

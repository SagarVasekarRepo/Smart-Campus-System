            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="CanteenFetchOperation?canteen=sibaca&want=menu" ><span><span>Manage Menu's</span></span></a></li>
                        <li><a href="CanteenFetchOperation?canteen=sibaca&want=staff"  class=" active"><span><span>Staff Details</span></span></a>
                                     
                                    </li>
                        <li><a href="CanteenFetchOperation?canteen=sibaca&want=contact"><span><span>Contact</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>Sibaca Canteen Staff</center></span><br>
                            </h2>
                            <center> 
                            <a href="canteenInsertOperation.jsp?canteen=SIBACA&insert=STAFF">Insert New Staff Member</a>
                            </center>
                         <br><br>
...
<%
        ...
        <td><a href="CanteenDeleteOperation?canteen=SIBACA&on=staff&id=<%= staff[count].emp_id %>">Delete</a></td>
        <td><a href="canteenUpdateOperation.jsp?canteen=SIBACA&update=STAFF&id=<%= staff[count].emp_id %>">Update</a></td>
        <%count++; %>
    </TR>
    <%} %>   </tbody> </table>

                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>Security Contacts Details</center></span><br>
                            </h2>
                            
                            <div class="PostContent">
                            
                            <center>
						 <a href="securityInsertOperation.jsp?insert=CONTACT">Insert New Contact Person</a>
...
<%
      ...
      <td><a href="SecurityDeleteOperation?on=CONTACT&id=<%= contacts[count].id %>">Delete</a><br><br>
        <a href="securityUpdateOperation.jsp?update=CONTACT&id=<%= contacts[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <tr></tr><tr></tr><tr></tr>
    <%} %>   </tbody> </table>

        ...
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                <div class="Header">
                    ...
                    <div class="logo">
                        <h1 id="name-text" class="logo-name"><a href="#">STES Canteen</a></h1>
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="CanteenFetchOperation?canteen=stes&want=staff"   class=" active"><span><span>Staff Details</span></span></a>
                                     
                                    </li>
                        <li><a href="CanteenFetchOperation?canteen=stes&want=contact"><span><span>Contact</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>STES Canteen Staff</center></span><br>
                            </h2>
                                                <center><a href="canteenInsertOperation.jsp?canteen=STES&insert=STAFF">Insert New Staff Member</a><br><br>
                                                </center>
...
<%
        ...
        <td><a href="CanteenDeleteOperation?canteen=STES&on=staff&id=<%= staff[count].emp_id %>">Delete</a></td>
        <td><a href="canteenUpdateOperation.jsp?canteen=STES&update=STAFF&id=<%= staff[count].emp_id %>">Update</a></td>
        <%count++; %>
    </TR>
    <%} %>   </tbody> </table>

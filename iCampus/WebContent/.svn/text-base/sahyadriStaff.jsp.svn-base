        ...
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                <div class="Header">
                    ...
                    <div class="logo">
                        <h1 id="name-text" class="logo-name"><a href="#">SAHYADRI HOSTEL STAFF</a></h1>
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="MessFetchOperation?mess=arjun&want=menu" ><span><span>Manage Menu's</span></span></a></li>
                        <li><a href="HostelFetchOperation?hostel=sahyadri&want=staff"  class=" active"><span><span>Staff Details</span></span></a>
                                     
                                    </li>
                        <li><a href="HostelFetchOperation?hostel=sahyadri&want=contact"><span><span>Contact Details</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>SHIVNERI HOSTEL STAFF</center></span><br>
                            </h2>
                            <center> 
                            <a href="hostelInsertOperation.jsp?hostel=SAHYADRI&insert=STAFF">Insert New Staff Member</a>
                            </center>
                         <br><br>
					 ...
					 <TABLE cellpadding="15" border="1" style="background-color: #ffffcc;" align="center" id="my_table">
					 <tbody>
<%
					Staff staff[]=(Staff[])request.getAttribute("result");
    				...
    				<TR id=count >
        <TD><%=staff[count].emp_id %></TD>
        <TD><%=staff[count].name %></TD>
        <TD><%=staff[count].role %></TD>
        <TD><%=staff[count].contact %></TD>
        <td><a href="HostelDeleteOperation?hostel=SAHYADRI&on=staff&id=<%= staff[count].emp_id %>">Delete</a></td>
        <td><a href="hostelUpdateOperation.jsp?hostel=SAHYADRI&update=STAFF&id=<%= staff[count].emp_id %>">Update</a></td>
        <%count++; %>
    </TR>
    <%} %>   </tbody> </table>

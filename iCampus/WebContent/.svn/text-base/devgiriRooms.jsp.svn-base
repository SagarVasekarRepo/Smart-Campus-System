            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="HostelFetchOperation?hostel=devgiri&want=staff"><span><span>Hostel Staff Details</span></span></a>
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>Devgiri Room Details</center></span><br>
                            </h2>
                            
                            <div class="PostContent">
                            
                            <center>
						 <a href="hostelInsertOperation.jsp?hostel=DEVGIRI&insert=ROOMDETAIL">Insert New Room Detail</a>
...
<%
      ...
      <td><a href="HostelDeleteOperation?hostel=DEVGIRI&on=ROOM&id=<%= rooms[count].id %>">Delete</a><br><br>
        <a href="hostelUpdateOperation.jsp?hostel=DEVGIRI&update=ROOM&id=<%= rooms[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <tr></tr><tr></tr><tr></tr>
    <%} %>   </tbody> </table>

            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="HostelFetchOperation?hostel=sahyadri&want=staff"><span><span>Staff Details</span></span></a>
                ...
                <div class="contentLayout">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            ...
                            <center>
						 <a href="hostelInsertOperation.jsp?hostel=SAHYADRI&insert=CONTACT">Insert New Contact Person</a>
...
<%
      ...
      <td><a href="HostelDeleteOperation?hostel=SAHYADRI&on=CONTACT&id1=<%= contacts[count].id %>">Delete</a><br><br>
        <a href="hostelUpdateOperation.jsp?hostel=SAHYADRI&update=CONTACT&id=<%= contacts[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <tr></tr><tr></tr><tr></tr>
    <%} %>   </tbody> </table>

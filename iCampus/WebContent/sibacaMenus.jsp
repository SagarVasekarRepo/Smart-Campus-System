            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="CanteenFetchOperation?canteen=SIBACA&want=MENU"  class=" active"><span><span>Manage Menu's</span></span></a></li>
                        <li><a href="CanteenFetchOperation?canteen=SIBACA&want=STAFF"><span><span>Staff Details</span></span></a>
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>Sibaca Canteen Menu's</center></span><br>
                            </h2>
                            
                            <div class="PostContent">
                            
                            <center>
						 <a href="canteenInsertOperation.jsp?canteen=SIBACA&insert=MENU">Insert New Menu</a><br><br>
...
<%
    				...
    				<TR id=count >
    	<TD><%=menus[count].id%></TD>
        <TD><%=menus[count].name %></TD>
        <TD><%=menus[count].price %></TD>
      <td><a href="CanteenDeleteOperation?canteen=SIBACA&on=MENU&id1=<%= menus[count].id %>">Delete</a></td>
        <td><a href="canteenUpdateOperation.jsp?canteen=SIBACA&update=MENU&id=<%= menus[count].id%>">Update</a></td>
        <%count++; %>
    </TR>
    <% }%>   </tbody> </table>

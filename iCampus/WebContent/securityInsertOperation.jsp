        ...
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                <div class="Header">
                    ...
                    <div class="logo">
                        <h1 id="name-text" class="logo-name"><a href="#">STES Lonava Security System</a></h1>
                        
                    </div>
                </div>
                <%if(insert.equalsIgnoreCase("contact")){ %>
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="SecurityFetchOperation?want=contact" class="active"><span><span>Contact Details</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                      ...
                      <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>ADDING NEW <%=insert %> TO SECURITY</center></span><br>
                            </h2>
                            ...
                            <div class="PostContent">
                                 ...
                                 <%
                                  ...
                                  if(insert.equalsIgnoreCase("staff"))
                                 {
                                  %>
                                   <form action="SecurityStaffInsert">
                                 ...
                                 {
                                 %>
                                   <form action="SecurityContactInsert">
                                 		<font face="Courier New" size="+1">
                                 		<br><br>
                                 				Enter the Name of Member   :: <input type="text" name="name" /><br><br><br><br>

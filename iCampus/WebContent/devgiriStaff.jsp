        ...
        <div class="Sheet">
            ...
            <div class="Sheet-body">
                <div class="Header">
                    ...
                    <div class="logo">
                        <h1 id="name-text" class="logo-name"><a href="#">DEVGIRI HOSTEL STAFF</a></h1>
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="HostelFetchOperation?hostel=devgiri&want=staff"  class=" active"><span><span>Staff Details</span></span></a>
                                     
                                    </li>
                        <li><a href="HostelFetchOperation?hostel=devgiri&want=contact"><span><span>Contact Details</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>DEVGIRI HOSTEL STAFF</center></span><br>
                            </h2>
                            <center> 
                            <a href="hostelInsertOperation.jsp?hostel=DEVGIRI&insert=STAFF">Insert New Staff Member</a>
                            </center>
                         <br><br>
...
<%
        ...
        <td><a href="HostelDeleteOperation?hostel=DEVGIRI&on=staff&id=<%= staff[count].emp_id %>">Delete</a></td>
        <td><a href="hostelUpdateOperation.jsp?hostel=DEVGIRI&update=STAFF&id=<%= staff[count].emp_id %>">Update</a></td>
        <%count++; %>
    </TR>
    <%} %>   </tbody> </table>

            ...
            <div class="Sheet-body">
                ...
                <div class="nav">
                    <ul class="artmenu">
                        ...
                        <li><a href="CanteenFetchOperation?canteen=sit&want=contact" class=" active"><span><span>Contact</span></span></a></li>
                    </ul>
                    <div class="l">
                    </div>
                    <div class="r">
                    ...
                    <div class="content">
                        ...
                        <div class="Post-inner">
                            <h2 class="PostHeaderIcon-wrapper">
                                <span class="PostHeader"><center>SIT Canteen Contacts Details</center></span><br>
                            </h2>
                         ...
                         <a href="canteenInsertOperation.jsp?canteen=SIT&insert=CONTACT">Insert New Contact Person</a><br><br>
						 </center>
                                        <br>
...
<%
      ...
      <td><a href="CanteenDeleteOperation?canteen=SIT&on=contact&id=<%= contacts[count].id %>">Delete</a><br><br>
        <a href="canteenUpdateOperation.jsp?canteen=SIT&update=CONTACT&id=<%= contacts[count].id %>">Update</a></td>
        <%count++; %>
    </TR>
    <tr></tr><tr></tr><tr></tr>
    <%} %>   </tbody> </table>

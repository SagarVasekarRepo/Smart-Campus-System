...
/**
 * Servlet implementation class SibacaContactInsert
 */
public class SibacaContactInsert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SibacaContactInsert() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MysqlConnect dao=new MysqlConnect();
			...
			try
			{
				...
				result=dao.insertContactSibaca(name, address,email,contact,role);

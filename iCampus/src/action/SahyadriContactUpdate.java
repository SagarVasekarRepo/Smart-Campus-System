...
/**
 * Servlet implementation class SahyadriContactUpdate
 */
public class SahyadriContactUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SahyadriContactUpdate() {
        super();
...
boolean result = false;
		...
		try 
		{
			...
			result=dao.sahyadriContactpdate(id1, name, address, email, contact, role);

...
/**
 * Servlet implementation class SahyadriContactInsert
 */
public class SahyadriContactInsert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SahyadriContactInsert() {
        super();
	...
	String name=request.getParameter("name");
		...
		DaoHostel dao=new DaoHostel();
			...
			try
			{
				...
				result=dao.insertContactSahyadri(name, address,email,contact,role);

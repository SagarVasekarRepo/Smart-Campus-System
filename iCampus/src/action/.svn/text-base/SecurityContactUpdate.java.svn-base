...
/**
 * Servlet implementation class SecurityContactUpdate
 */
public class SecurityContactUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SecurityContactUpdate() {
        super();
...
boolean result = false;
		...
		try 
		{
			...
			result=dao.securityContactpdate(id1, name, address, email, contact, role);

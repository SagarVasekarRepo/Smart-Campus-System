...
/**
 * Servlet implementation class SibacaMenuUpdate
 */
public class SibacaMenuUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SibacaMenuUpdate() {
        super();
...
boolean result = false;
		...
		try 
		{
			...
			result=dao.sibacaMenuUpdate(id1,name,price);

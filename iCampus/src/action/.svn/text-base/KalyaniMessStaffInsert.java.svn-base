...
/**
 * Servlet implementation class KalyaniMessStaffInsert
 */
public class KalyaniMessStaffInsert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public KalyaniMessStaffInsert() {
        super();
	...
	String name=request.getParameter("name");
		...
		DaoMess dao=new DaoMess();
			...
			try
			{
				...
				result=dao.insertStaffKalyani(name, role,contact);

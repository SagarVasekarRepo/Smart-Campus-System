...
/**
 * Servlet implementation class SahyadriStaffInsert
 */
public class SahyadriStaffInsert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SahyadriStaffInsert() {
        super();
...
String name=request.getParameter("name");
		...
		DaoHostel dao=new DaoHostel();
			...
			try
			{
				...
				result=dao.insertStaffSahyadri(name, role,contact);

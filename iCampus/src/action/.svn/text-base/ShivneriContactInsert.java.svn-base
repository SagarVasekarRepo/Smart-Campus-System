...
/**
 * Servlet implementation class ShivneriContactInsert
 */
public class ShivneriContactInsert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShivneriContactInsert() {
        super();
	...
	String name=request.getParameter("name");
		...
		DaoHostel dao=new DaoHostel();
			...
			try
			{
				...
				result=dao.insertContactShivneri(name, address,email,contact,role);

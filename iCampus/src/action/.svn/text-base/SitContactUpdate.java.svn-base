...
/**
 * Servlet implementation class SitContactUpdate
 */
public class SitContactUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SitContactUpdate() {
        super();
...
boolean result = false;
		...
		try 
		{
			...
			result=dao.sitContactpdate(id1, name, address, email, contact, role);

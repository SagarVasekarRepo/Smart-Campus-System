...
/**
 * Servlet implementation class StesContactUpdate
 */
public class StesContactUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StesContactUpdate() {
        super();
...
boolean result = false;
		...
		try 
		{
			...
			result=dao.stesContactpdate(id1, name, address, email, contact, role);

...
/**
 * Servlet implementation class DevgiriRoomUpdate
 */
public class DevgiriRoomUpdate extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DevgiriRoomUpdate() {
        super();
...
boolean result = false;
		...
		try 
		{
			...
			result=dao.devgiriRoomUpdate(id1, name, room);
